...
// Action template: change vertical position of the louver 
...
// Action template: change horizontal position of the louver 
...
// Action template: change vertical swing mode of the louver 
...
// Action template: change horizontal swing mode of the louver 
...
// Action template: turn on the display
...
// Action template: turn off the display
...
// Action template: turn on the beeper
...
// Action template: turn off the beeper
...
// Action template: turn on the module indicator
...
// Action template: turn off the module indicator
...
// Action template: enable forced application of settings
...
// Action template: disable forced application of settings
